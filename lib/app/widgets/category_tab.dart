...
class _CustomTabBarSectionState extends State<CustomTabBarSection> {
  ...
  String _getUnescapedSvg(String rawIcon) {
    if (_svgCache.containsKey(rawIcon)) return _svgCache[rawIcon]!;
    final unescaped = htmlUnescape(rawIcon);
    _svgCache[rawIcon] = unescaped;
    return unescaped;
  }
          ...
          children: [
            SizedBox(
              ...
              child: Builder(
                builder: (context) {
                  try {
                    final decodedSvg = _getUnescapedSvg(icon);
            ...
            AnimatedPositioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Colors.white.withValues(alpha: 0.3), // Changed to white
                      blurRadius: 4,
