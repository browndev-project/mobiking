    ...
    return Column(
      ...
      children: questions.map((question) {
        return Padding(
          ...
          child: Material(
            color: AppColors.lightPurple.withValues(alpha: 0.1), // Light, translucent background
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: AppColors.primaryPurple.withValues(alpha: 0.3)), // Subtle border
                  borderRadius: BorderRadius.circular(10.0),
                ),
                child: Text(
                  question,
