...
class _AddressPageState extends State<AddressPage> {
              ...
              () => SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 2,
                    disabledBackgroundColor: AppColors.blinkitGreen.withValues(alpha:
                      0.6,
                    ),
                  ),
                ),
  ...
  Widget buildEmailFieldWithHelper() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildUserTextField(
                ...
                child: CustomPaint(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppColors.textDark.withValues(alpha:
                          isSelected ? 0.1 : 0.05,
                          ),
                          blurRadius: 6,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.only(bottom: 20),
              decoration: BoxDecoration(
                color: AppColors.blinkitGreen.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: AppColors.blinkitGreen.withValues(alpha: 0.3),
                ),
              ),
              child: Row(
                children: [
  ...
  Future<void> saveUserInfoQuick() async {
