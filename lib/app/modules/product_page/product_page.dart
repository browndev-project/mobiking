...
import 'package:mobiking/app/modules/home/widgets/all_product_grid_card.dart';
...
import 'package:mobiking/app/modules/home/widgets/floating_cart_button.dart';
...
class _ProductPageState extends State<ProductPage>
  ...
  final RxBool isCheckingDelivery = false.obs;
  ...
  void initState() {
    ...
    slideAnimation = Tween<Offset>(begin: Offset.zero, end: const Offset(0, 1))
        .animate(
          CurvedAnimation(
  ...
  String _sanitizeHtml(String htmlString) {
    ...
    try {
      ...
      debugPrint("HTML sanitization error: $e");
          ...
          TagExtension(
            ...
            builder: (extensionContext) {
              ...
              if (src == null || src.isEmpty) {
                debugPrint("❌ Image src is null or empty");
                return _buildImageErrorWidget(alt);
              }

              debugPrint("✅ Loading image from: $src");
  ...
  String _convertHtmlToPlainText(String htmlString) {
    ...
    try {
      ...
      debugPrint("HTML to text conversion error: $e");
                            ...
                            children: List.generate(
                              ...
                              (index) {
                                ...
                                return ChoiceChip(
                                  ...
                                  selectedColor: AppColors.success.withValues(alpha:
                                    0.1,
                                  ),
  ...
  Widget _buildEmptyState(TextTheme textTheme) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.neutralBackground.withValues(alpha:0.5),
        borderRadius: BorderRadius.circular(12),
