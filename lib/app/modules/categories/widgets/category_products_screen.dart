...
import '../../home/widgets/all_products_grid_view.dart'; // If you want to navigate to products from subcategories
                ...
                return CategoryTile(
                  ...
                  onTap: () {
                    ...
                    if (subCategory.products.isNotEmpty) {
                      debugPrint('Products in ${subCategory.name}:');
                      ...
                      debugPrint('No products found for ${subCategory.name}');
                    }
