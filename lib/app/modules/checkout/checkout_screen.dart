...
import '../home/widgets/all_product_grid_card.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  String getCouponCode(dynamic coupon) {
    try {
      ...
      debugPrint('Error getting coupon code: $e');
      return 'CODE';
    }
  }

  String getCouponDiscountText(dynamic coupon) {
    try {
      ...
      debugPrint('Error parsing coupon discount: $e');
      return "OFFER";
    }
  }

  bool isCouponUsable(dynamic coupon) {
    try {
  ...
  void selectCouponSafely(dynamic coupon) {
    try {
  ...
  void _handlePlaceOrder(BuildContext context) async {
    ...
    try {
      ...
      debugPrint('[CheckoutScreen] Order data with GST: $orderData'); // Added log
